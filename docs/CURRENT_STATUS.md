...
- 최신 완료: Phase 3 전용 아트·등급 프레임·320×700/390×844 핵심 화면 시각 QA, 주요 액션 버튼 44px 터치 영역, 숫자 그룹 표기, 피해 로그 강조, 경맥 노드 접근성 의미, 전투 로그 용어집
...
- 마지막 commit: `37324c8 docs: add combat log glossary`
