...
- 최신 완료: Phase 3 전용 아트·등급 프레임·320×700/390×844 핵심 화면 시각 QA, 공통 경맥 버튼 44px 터치 영역, 숫자 그룹 표기
- 현재 작업: Phase 4 전투 로그 용어·숫자 표기 및 터치 접근성 점검
- 바로 다음 작업: 전투 로그 용어집 정리와 나머지 주요 액션 버튼 44px 점검
...
- 마지막 commit: `216afaa feat: standardize combat number formatting`
