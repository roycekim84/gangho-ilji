...
- 최신 완료: Phase 3 전용 아트·등급 프레임·320×700/390×844 핵심 화면 시각 QA, 주요 액션 버튼 44px 터치 영역, 숫자 그룹 표기, 피해 로그 강조
- 현재 작업: Phase 4 전투 로그 용어·숫자 표기 및 터치 접근성 점검
- 바로 다음 작업: 전투 로그 용어집 정리 및 키보드 포커스 순서 점검
...
- 마지막 commit: `2bc10b6 feat: clarify combat log damage feedback`
